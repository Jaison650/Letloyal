...
import { QrCode, Phone, Lock, Eye, EyeOff, User, AlertCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-brand-bg flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="font-sora font-bold text-3xl mt-6">Create Your Loyalty Account</h1>
