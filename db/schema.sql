-- LetLoyal Database Schema
-- MySQL 8.0+
-- Run: mysql -u letloyal -p letloyal < db/schema.sql
...
CREATE INDEX IF NOT EXISTS idx_enrollments_merchant   ON enrollments(merchant_id);
CREATE INDEX IF NOT EXISTS idx_txn_customer           ON point_transactions(customer_id);
CREATE INDEX IF NOT EXISTS idx_txn_campaign           ON point_transactions(campaign_id);
CREATE INDEX IF NOT EXISTS idx_txn_created            ON point_transactions(created_at);
CREATE INDEX IF NOT EXISTS idx_redemptions_enrollment ON redemptions(enrollment_id);
...
-- Trigger 1: increment participants_count when a new enrollment is created
...
-- Trigger 2: increment redemptions_count when a redemption is validated
